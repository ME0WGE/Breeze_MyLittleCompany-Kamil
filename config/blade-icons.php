...
return [
    ...
    */
    ...
    'sets' => [
        ...
        'default' => [
            /* Path relative to the project root or disk root */
            'path' => 'resources/svg',

            /* Optional filesystem disk (leave empty to use local filesystem) */
            'disk' => '',

            /* Prefix applied to icons in this set (unique per set) */
            'prefix' => 'icon',

            /* Optional fallback icon within this set */
            'fallback' => '',

            /* Default classes applied to icons from this set */
            'class' => '',

            /* Default attributes for icons from this set */
            'attributes' => [
                // 'width' => 50,
                // 'height' => 50,
            ],
